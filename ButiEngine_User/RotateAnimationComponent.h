...
namespace ButiEngine {
	...
	class RotateAnimationComponent :public GameComponent
	{
	public:

		std::string GetGameComponentName()const override {
			return "RotateAnimationComponent";
		}
		...
		void SetAxisType(const std::int8_t arg_axisType) { m_rotateAxisType = arg_axisType; }
	...
	private:
		...
		std::int8_t m_rotateAxisType;
	};

}

BUTI_REGIST_GAMECOMPONENT(RotateAnimationComponent, true);
